...
def ancillary_list(date):
    ...
    #    file_types = ['TOAST','O3_AURAOMI_24h','O3_EPTOMS_24h','MET_NCEPR2_6h','MET_NCEPR2_6h_NEXT']
    #else:
    #    file_types = ['TOAST','O3_AURAOMI_24h','MET_NCEP','MET_NCEP_NEXT']
    #    file_types = ['TOAST',,'O3_EPTOMS_24h','MET_NCEPR2_6h','MET_NCEPR2_6h_NEXT']
